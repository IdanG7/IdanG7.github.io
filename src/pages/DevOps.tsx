...
const DevOps = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Services Section */}
      <section id="services" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`h-full transition-all duration-300 bg-card/50 backdrop-blur-sm border ${
                        hoveredService === index ? "border-primary/40 shadow-lg" : "border-border/50"
                      }`}
                    >
                      <CardHeader className="pb-4">
                        <div className="flex items-center justify-between mb-3">
                          <div className={`p-2.5 rounded-lg bg-primary/10 ${service.iconColor}`}>
                            <Icon className="w-6 h-6" />
                          </div>
                          <Badge
                            variant="outline"
                            className="font-mono text-xs font-semibold border-primary/30"
                          >
                            {service.highlight}
                          </Badge>
                        </div>
      ...
      <section id="case-studies" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
            ...
            <div className="space-y-6">
              {caseStudies.map((study, index) => {
                ...
                return (
                  ...
                  >
                    <Card
                      className={`transition-all duration-300 bg-card/50 backdrop-blur-sm border ${
                        hoveredCase === index ? "border-primary/40 shadow-lg" : "border-border/50"
                      }`}
                    >
                      <CardContent className="p-6">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                          ...
                          <div className="lg:col-span-3 flex flex-col">
                            <div className={`p-2.5 rounded-lg bg-primary/10 w-fit mb-3 ${study.iconColor || 'text-primary'}`}>
                              <Icon className="w-5 h-5" />
                            </div>
                            <h3 className="text-xl font-bold font-mono mb-1">{study.title}</h3>
                            <p className="text-sm text-muted-foreground font-medium">{study.subtitle}</p>
                          </div>
                          ...
                          <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-3 gap-6">
                            {/* Challenge */}
                            <div>
                              <h4 className="text-xs font-bold text-primary/70 uppercase tracking-wider mb-2">Challenge</h4>
                              <p className="text-sm text-foreground leading-relaxed">{study.challenge}</p>
                            </div>

                            {/* Solution */}
                            <div>
                              <h4 className="text-xs font-bold text-primary/70 uppercase tracking-wider mb-2">Solution</h4>
                              <p className="text-sm text-foreground leading-relaxed">{study.solution}</p>
                            </div>

                            {/* Results */}
                            <div>
                              <h4 className="text-xs font-bold text-primary/70 uppercase tracking-wider mb-2">Results</h4>
                              <ul className="space-y-1.5">
                                {study.results.map((result, i) => (
                                  <li key={i} className="flex items-start gap-2 text-sm">
                                    <div className="w-1 h-1 rounded-full bg-primary mt-2 flex-shrink-0" />
                                    <span className="text-foreground font-semibold font-mono text-xs leading-relaxed">{result}</span>
                                  </li>
                                ))}
                              </ul>
                              <div className="mt-4 pt-4 border-t border-border/50">
                                <p className="text-xs text-primary font-semibold leading-relaxed">{study.impact}</p>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
      ...
      {/* Experience Section */}
      <section id="experience" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
              ...
              {experience.map((exp, index) => (
                ...
                >
                  <Card className="h-full hover:shadow-xl transition-all duration-500 bg-card/50 backdrop-blur-sm border-2 hover:border-primary/30">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        <h4 className="text-sm font-bold font-mono text-primary flex items-center gap-2 mb-4">
                        ...
                        <ul className="space-y-4">
                          {exp.achievements.map((achievement, i) => (
                            ...
                            >
                              ...
                              <p className="text-sm text-foreground leading-relaxed font-medium">{achievement}</p>
                            </motion.li>
                          ))}
                        </ul>
                      </div>
      ...
      <section id="technologies" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
      ...
      {/* Contact CTA Section */}
      <section id="contact" className="py-16 px-4 sm:px-6 lg:px-8 relative scroll-mt-24">
        ...
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            className="relative"
          >
            <Card className="overflow-hidden bg-card/50 backdrop-blur-sm border border-border/50 shadow-lg">
              <CardContent className="relative pt-12 pb-12 space-y-8">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Available for contract work to help optimize your build pipelines, resolve CI/CD issues, and implement DevOps automation solutions.
                  </p>
                </div>

                {/* Stats */}
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto py-6 border-y border-border/50">
                  <div className="text-center space-y-1">
                    <div className="text-3xl font-bold font-mono text-primary">70+</div>
                    <p className="text-xs text-muted-foreground font-medium">Production Pipelines</p>
                  </div>
                  <div className="text-center space-y-1">
                    <div className="text-3xl font-bold font-mono text-primary">30-50%</div>
                    <p className="text-xs text-muted-foreground font-medium">Build Time Reduction</p>
                  </div>
                  <div className="text-center space-y-1">
                    <div className="text-3xl font-bold font-mono text-primary">100+</div>
                    <p className="text-xs text-muted-foreground font-medium">Issues Resolved</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
                  <Button
                    size="lg"
                    className="font-mono text-sm px-6 py-5 w-full sm:w-auto"
                    asChild
                  >
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="font-mono text-sm px-6 py-5 border-primary/30 w-full sm:w-auto"
                    asChild
                  >
                    <a href="/resume-devops.pdf" target="_blank" rel="noopener noreferrer">
                      <ExternalLink className="w-4 h-4 mr-2" />
