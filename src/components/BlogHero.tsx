...
export default function BlogHero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const name = selector(".blog-name-container");
      const tagline = selector(".blog-tagline-part");
      ...
      gsap
        ...
        .to(name, {
          ...
          onComplete: () => {
            document
              .querySelectorAll(".blog-name-container")
        ...
        .to(
          tagline,
          {
            ...
            onComplete: () => {
              document
                .querySelectorAll(".blog-tagline-part")
                .forEach((el) => el.classList.add("gsap-animated"));
            },
          },
          "-=1.2"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-full z-10 pointer-events-none">
        <div className="blog-name-container gsap-hero-title select-none will-change-transform">
        ...
        <div className="mt-8 text-center space-y-2 md:space-y-4">
          <p className="blog-tagline-part gsap-hero-tagline text-xs md:text-xl tracking-[0.4em] uppercase text-neutral-500 dark:text-white/40 font-outfit font-semibold">
            Thoughts, learnings, and
          </p>
          <div className="blog-tagline-part gsap-hero-tagline relative inline-block">
            <p className="font-nyght text-4xl md:text-7xl italic text-neutral-900 dark:text-white lowercase leading-tight">
              deep dives into the craft.
            </p>
          </div>
        </div>
      </div>
