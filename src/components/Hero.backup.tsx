      ...
      <div className="max-w-5xl w-full">
        ...
        >
          <div className="space-y-6">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light tracking-tight font-mono opacity-0 animate-fade-in animate-delay-200 flex items-center justify-center gap-3">
              <TypewriterText
                text="Idan Gurevich"
                speed={120}
                delay={1200}
              ...
              />
              <span
                className="inline-block text-6xl sm:text-7xl md:text-8xl origin-[70%_70%]"
                style={{ animation: "wave 2.5s ease-in-out infinite", animationDelay: "3.5s" }}
              >
                👋
              </span>
            </h1>
